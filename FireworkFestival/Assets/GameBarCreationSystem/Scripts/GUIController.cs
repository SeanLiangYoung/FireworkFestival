...
class GUIController : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        maxHealth = health_bar.getMaxValue(100);
        health_bar.IncrimentBar(maxHealth/2);
    }
    ...
    public void IncreLiveBar( int step )
    {
        health_bar.IncrimentBar(step);

    }

    public bool IsLiveZero()
    {
